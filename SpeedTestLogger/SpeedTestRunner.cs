...
namespace SpeedTestLogger
{
  public class SpeedTestRunner
  {
    ...
    {
      var server = FindTestServer(_client, _settings);
      ...
      return CreateTestData(server, downloadSpeed, uploadSpeed);
    }

    private TestData CreateTestData(Server server, double downloadSpeed, double uploadSpeed)
    {
      return new TestData
      {
